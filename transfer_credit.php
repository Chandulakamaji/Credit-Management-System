		...
		<form action="transfer_op.php" method="post">
			...
			<select name="status1" id="status">
				...
				<?php
					...
					$result = mysqli_query($conn, "SELECT name FROM user_id "); 
					while($res = mysqli_fetch_array($result)) { 
  				...
  				<br>
  				<br>
  				<input type="number" name="credit" placeholder="Enter Value" required size="50"  style="border-radius:5px;padding:4px 15px;border-width:1px;border-color:black; width:90%;">
  				<br><br><br>
